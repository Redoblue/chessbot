...
class OnRobotGripperRG2(object):
    def __init__(self, robot):
        self.robot = robot
    def open_gripper(self, target_width=65, target_force=40, payload=0.5, set_payload=False, depth_compensation=False, slave=False, wait=2):
        ...
        time.sleep(wait)
    def close_gripper(self, target_width=42, target_force=40, payload=0.5, set_payload=False, depth_compensation=False, slave=False, wait=2):
        urscript = OnRobotGripperRG2Script()
        urscript._rg2_command(target_width, target_force, payload, set_payload, depth_compensation, slave)
        self.robot.send_program(urscript())
        time.sleep(wait)
...
if __name__ == '__main__':
    from bot_mover2 import BotMover

    bot = BotMover()
    rg2 = OnRobotGripperRG2(bot.robot)
