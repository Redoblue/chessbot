...
class HandDetector:
    ...
    def init_detection_corners(self, corners):
        self.hand_corners = []
        self.hand_corners.append((corners[2][0]-100, corners[2][1]-100))
        self.hand_corners.append((corners[3][0]+100, corners[3][1]-100))
        self.hand_corners.append((corners[0][0]-100, corners[0][1]+100))
        self.hand_corners.append((corners[1][0]+100, corners[1][1]+100))
