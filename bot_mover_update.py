...
class BotMover:
    ...
    def move_pose(self, pose_vector):
        ...
        self.robot.movel(pose_vector, acc=self.ACC, vel=self.VEL, wait=True, threshold=0.001)

    def move_joint(self, joint_vector):
        self.robot.movej(joint_vector, acc=0.7, vel=0.5, wait=True, threshold=0.001)
